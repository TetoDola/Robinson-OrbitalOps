...
const BULLETS = ["30-minute demo", "Needs discovery call", "Yard ROI assessment"] as const;
      ...
      <div className="site-container grid gap-14 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
          ...
          <p className="mt-6 max-w-md text-[var(--c-gray)]">
            Fill out the form, and we&apos;ll be happy to discuss how Terminal can help you with your yard of the future:
          </p>
          ...
          <div className="mt-12">
            <p className="eyebrow text-[var(--c-dark-gray)]">Trusted by those in the know.</p>
